...
export function AnswerChart() {
  ...
  const chartData = [
    {
      type: 'Correct',
      value: answers?.submission?.correctAnswers ?? 0,
      fill: '#00BC7D',
    },
    {
      type: 'Incorrect',
      value: answers?.submission?.wrongAnswers ?? 0,
      fill: '#EF4444',
    },
  ];
      ...
      <CardFooter className="flex flex-col items-start gap-3 px-6 text-sm">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm font-medium text-black">
            Correct: {answers?.submission?.correctAnswers ?? 0}
          </span>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm font-medium text-black">
            Incorrect: {answers?.submission?.wrongAnswers ?? 0}
          </span>
        </div>
      </CardFooter>
    </Card>
